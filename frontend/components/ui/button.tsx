...
const buttonVariants = cva(
  "inline-flex min-w-0 items-center justify-center rounded-xl text-center text-sm font-semibold transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
